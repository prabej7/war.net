...
const WarCard: React.FC<WarZone> = ({ description, name, severity, id, latitude, longitude }) => {
    ...
    return <Pressable style={styles.container} onPress={() => onView(id)}>
        <View>
            <Image
        ...
        <View style={{ width: "60%" }} >
            <View style={{ flexDirection: "row", gap: 4, alignItems: "center" }}>
                ...
                <View style={[{ backgroundColor: getColors(severity)[0] }, styles.indicator]} />
            </View>

            <Text style={styles.subtitle} >{description}</Text>
            <View style={{ flexDirection: "row", gap: 4 }} >
                <Text style={{ color: primary }} onPress={() => onView(id)} >View</Text>
            </View>
